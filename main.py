...
from src.ui.opencv_demo import opencv, process_video
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Workout Form Optimizer - Analyze exercise form from webcam or video file"
    )
    parser.add_argument(
        "video_path",
        type=str,
        nargs="?",
        default=None,
        help="Path to input video file (omit for webcam mode)",
    )
    parser.add_argument(
        "-e", "--exercise",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional path to save output video with analysis overlay (video file mode only)",
    )
